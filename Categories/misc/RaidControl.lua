...
local isEnabled = E.private["NoBorders"] and E.private["NoBorders"]["RaidControl"] and true or false
...
local function ConfigTable()
	E.Options.args.NoBorders.args.Misc.args.options.args.RaidControl = {
		type = "group",
		name = "RaidControl",
		get = function(info) return E.db.NoBorders.RaidControl[info[#info]] end,
		set = function(info, value) E.db.NoBorders.RaidControl[info[#info]] = value; UpdateRaidControl() end,
		args = {
			hide = {
				order = 1,
				type = "toggle",
...
function UpdateRaidControl()
	...
	if (E.db.NoBorders.RaidControl.hide) then
		RaidUtility_ShowButton:Hide()
		RaidUtilityPanel:Hide()
	end
	if (E.db.NoBorders.RaidControl.transparent) then
